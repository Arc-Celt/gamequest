...
def batch_add(collection, df, emb_col, id_col, label, is_critic=False):
...
batch_add(desc_collection, desc_emb, 'embedding', 'game_id', 'Descriptions')
batch_add(cover_collection, cover_emb, 'cover_embedding', 'game_id', 'Covers')
